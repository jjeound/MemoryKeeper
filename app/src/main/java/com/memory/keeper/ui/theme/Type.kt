...
data class CustomTypography(
    ...
    companion object {
        ...
        fun defaultCustomTypography(fontFamily: FontFamily): CustomTypography = CustomTypography(
            ...
            button = TextStyle(fontFamily = fontFamily, fontWeight = FontWeight.Bold, fontSize = 15.sp),
            ...
            keywordLarge = TextStyle(fontFamily = fontFamily, fontWeight = FontWeight.Bold, fontSize = 20.sp),
